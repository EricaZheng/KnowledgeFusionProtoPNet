...
from models import model_cross_attn
from core import push
import train_test.train_and_test as tnt
from utils import save
from utils.log import create_logger
from datasets.preprocess import mean, std, preprocess_input_function, undo_preprocess_input_function
import argparse
...
test_image_dir = '../local_analysis/Art_1/'  # TODO
test_image_name = 'Bike_00049.jpg'
test_image_label = 4
...
# load_model_dir = args.modeldir[0] #'./saved_models/vgg19/003/' # TODO
# load_model_name = args.model[0] #'10_18push0.7822.pth'
# load_model_dir = '../saved_models/original/split_80_20/Art/2022_11_06_14:40:23/'

# ProtoPNet
# load_model_dir = '../saved_models_ST309/resnet50/original/split_80_20/Art/2022_11_06_14:40:23/'
# load_model_name = '20nopush0.6450.pth'

# Ours
load_model_dir = '../saved_models_ST309/resnet50/cross_attn/split_80_20/Art/2022_11_07_07:50:15/'
load_model_name = '10nopush0.6331.pth'
...
test_dir = '/home/bizon/Dataset/Office-Home/datasets_office_home_split_aug/Art/test/'
if check_test_accu:
    test_batch_size = 100
...
# img_pil = Image.open(test_image_path) # ZZ
img_pil = Image.open(test_image_path).convert('RGB') # ZZ
...
logits, min_distances, _ = ppnet_multi(images_test)  # ZZ
