...
from datasets.preprocess import preprocess_input_function
...
test_image_dir = '../local_analysis/Clock/'
test_image_name = 'Clock_1.png'
test_image_label = 0

load_model_path = os.path.join(load_model_dir, load_model_name)
# load_model_path = './saved_models/vgg19/003/14nopush0.7644.pth'   # Debug
...
# !!!
# prototype_info = np.load('./saved_models/vgg19/003/img/epoch-19/bb19.npy')
