...
method = 'cross_attn'
from settingsCUB import img_size, prototype_shape, num_classes, \
...
model_dir = './saved_models_CUB/' + base_architecture + '/' + method + '/' + experiment_run + '/'
makedir(model_dir)

shutil.copy(src=os.path.join(os.getcwd(), __file__), dst=model_dir)
shutil.copy(src=os.path.join(os.getcwd(), 'settingsCUB.py'), dst=model_dir)
...
# load data
from settingsCUB import train_batch_size, test_batch_size, train_push_batch_size
...
train_dir = '/home/Dataset/CUB/train_augmented/'
...
train_push_dir = '/home/Dataset/CUB/train/'
train_push_dataset = ds.ImageFolder(
    train_push_dir,
    transforms.Compose([
        transforms.Resize(size=(img_size, img_size)),
        transforms.ToTensor(),
...
# test set
mode = 'test'
test_dir = '/home/Dataset/CUB/test'
test_dataset = ds.ImageFolder(
    test_dir,
    transforms.Compose([
        transforms.Resize(size=(img_size, img_size)),
        transforms.ToTensor(),
...
# define optimizer
from settingsCUB import joint_optimizer_lrs, joint_lr_step_size
...
from settingsCUB import warm_optimizer_lrs
...
from settingsCUB import last_layer_optimizer_lr

last_layer_optimizer_specs = [{'params': ppnet.last_layer.parameters(), 'lr': last_layer_optimizer_lr}]
last_layer_optimizer = torch.optim.Adam(last_layer_optimizer_specs)

# weighting of different training losses
from settingsCUB import coefs

# number of training epochs, number of warm epochs, push start epoch, push epochs
from settingsCUB import num_train_epochs, num_warm_epochs, push_start, push_epochs
